...
A map of the soil is an issue of distinctions, not a fact-check and not a debate. Issue I — Gaza.
...
1. Какую фразу вы сказали вслух?
2. Был ли вопрос о норме честным — или он подталкивал к ответу?
3. Где сталь слабее, чем противоположная позиция заслуживает?
4. Какой документ вы открыли по URL и что там нашли (совпало / не совпало / ссылка мертва)?
5. Чего не хватает, без чего вы не дали бы это читать коллеге?

## Триаж ответов

| рубрика | куда |
|---|---|
| ошибка в норме | корпусный бриф, приоритет, `changelog` |
| ошибка в документе | корпусный бриф, `archive`/`url`/`why` |
| слабая сталь | A3b |
| язык | A5, носитель |
| интерфейс | отдельный бриф B, не корпус |

Круг: 30–50 человек. По каждому языку не меньше восьми. Юристы МГП, журналисты, философы, историки.
